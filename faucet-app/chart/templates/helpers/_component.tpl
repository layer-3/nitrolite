...
*/}}
{{- define "faucet-app.component.metricsAnnotations" -}}
...
*/}}
{{- define "faucet-app.component.replicaCount" -}}
...
*/}}
{{- define "faucet-app.component.image" -}}
...
*/}}
{{- define "faucet-app.component.ports" -}}
{{- if .http.enabled }}
ports:
{{- with .http }}
- name: http
...
*/}}
{{- define "faucet-app.component.resources" -}}
resources:
  requests:
...
*/}}
{{- define "faucet-app.component.probes" -}}
