...
func printUsage() {
	fmt.Println("Usage: nitronode stress-test <strategy> [args...]")
	fmt.Println()
	...
	fmt.Println("  nitronode stress-test basic ping:1000:10")
	fmt.Println("  nitronode stress-test storm ...")
	fmt.Println()
	fmt.Println("Run 'nitronode stress-test <strategy>' for strategy-specific help.")
}

func printBasicUsage() {
	fmt.Println("Usage: nitronode stress-test basic <spec>")
	fmt.Println()
	fmt.Println("Spec format: method:total_requests[:connections[:extra_params...]]")
	fmt.Println()
	fmt.Println("Environment variables:")
	fmt.Println("  STRESS_WS_URL          (required) WebSocket URL of the nitronode")
	...
	fmt.Println("  nitronode stress-test basic ping:1000:10")
	fmt.Println("  nitronode stress-test basic get-config:500:5")
	fmt.Println("  nitronode stress-test basic get-balances:2000:20:0xWALLET")
	fmt.Println("  nitronode stress-test basic get-home-channel:1000:10:usdc")
	fmt.Println()
	...
	fmt.Println("    nitronode stress-test basic transfer-roundtrip:10:100:usdc")
	fmt.Println("    nitronode stress-test basic transfer-roundtrip:10:100:usdc:0.0001")
	fmt.Println()
	fmt.Println("  app-session-lifecycle:sessions:participants:operates:asset[:amount]")
	fmt.Println("    nitronode stress-test basic app-session-lifecycle:10:5:3:usdc")
	fmt.Println("    nitronode stress-test basic app-session-lifecycle:10:5:3:usdc:0.000005")
}
