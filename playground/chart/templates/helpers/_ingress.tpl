...
*/}}
{{- define "playground.ingress.apiVersion" -}}
...
*/}}
{{- define "playground.ingress.annotations" -}}
...
*/}}
{{- define "playground.ingress.httpPath" -}}
...
- path: {{ $http.path }}
  ...
  {{- end }}
  backend:
    {{ $svcName := include "playground.common.fullname" . }}
